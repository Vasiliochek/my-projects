<template>
  <div :class="['book']" v-if="book.onShelf">
    ...
    <div class="book-body">
      ...
      <div class="btns-container">
        <button class="readed-btn" @click="readedBook">Already readed</button>
        <button class="delete-btn" @click="deleteFromShelf">Delete</button>
      </div>
    </div>
